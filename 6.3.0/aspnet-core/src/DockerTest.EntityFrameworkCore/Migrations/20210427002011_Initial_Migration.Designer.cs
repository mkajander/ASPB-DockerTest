...
namespace DockerTest.Migrations
{
    ...
    [Migration("20210427002011_Initial_Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DockerTest.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DockerTest.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DockerTest.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("DockerTest.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("DockerTest.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("DockerTest.Authorization.Roles.Role", b =>
                {
                    b.HasOne("DockerTest.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("DockerTest.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("DockerTest.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
