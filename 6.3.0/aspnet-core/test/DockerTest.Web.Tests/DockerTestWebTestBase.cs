...
{
    public abstract class DockerTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DockerTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DockerTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DockerTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DockerTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DockerTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DockerTestDbContext, Task<T>> func)
        {
            T result;
